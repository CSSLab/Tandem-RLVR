...
class RolloutConfig(BaseConfig):
    ...
    val_response_length: Optional[int] = None  # TANDEM: Override response length for validation
    ...
    # TANDEM: Configuration for tandem rollout
    tandem: dict = field(default_factory=dict)

...
@dataclass
class TandemConfig:
    """Configuration for tandem generation with two models."""
...
class VllmConfig:
    ...
    speculative_config: SpeculativeConfig = field(default=None,
                                                  init=True)  # type: ignore
    tandem_config: Optional[TandemConfig] = None

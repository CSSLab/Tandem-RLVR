...
from vllm.config import (BlockSize, CacheConfig, CacheDType, CompilationConfig,
                         ...
                         TandemConfig, TaskOption, TokenizerPoolConfig,
                         VllmConfig,
...
class EngineArgs:
    ...
    tandem_config: Optional[Dict[str, Any]] = None
    ...
    def create_tandem_config(
        ...
        target_model_config: "ModelConfig",
        target_parallel_config: "ParallelConfig",
    ) -> Optional["TandemConfig"]:
        if self.tandem_config is None:
            return None
        self.tandem_config.update({
            "target_model_config": target_model_config,
            "target_parallel_config": target_parallel_config,
        })
        return TandemConfig.from_dict(self.tandem_config)

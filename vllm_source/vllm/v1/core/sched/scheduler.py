...
class Scheduler(SchedulerInterface):
    ...
    def update_from_output(
        ...
        tandem_model_mask = model_runner_output.tandem_model_mask
        ...
        for request in self.running:
            ...
            new_tandem_mask = None
            if tandem_model_mask is not None:
                new_tandem_mask = tandem_model_mask[req_index]
            ...
            if new_token_ids:
                ...
                outputs.append(
                    EngineCoreOutput(
                        ...
                        new_tandem_model_mask=new_tandem_mask))
            else:

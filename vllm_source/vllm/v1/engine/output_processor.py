...
class RequestState:
    ...
    def _new_completion_output(
        ...
        tandem_mask = self.tandem_model_mask if self.tandem_model_mask else None
    ...
    def process_outputs(
        ...
        **********************************************************
        ...
        for engine_core_output in engine_core_outputs:
            ...
            if engine_core_output.new_tandem_model_mask is not None:
                req_state.tandem_model_mask.extend(
                    engine_core_output.new_tandem_model_mask)
